...
(function () {
  ...
  var REPORTS = ["0.5.11", "0.5.12"];
  var REPORT_BASE =
    "https://pharmar.github.io/pharmapkgs/src/contrib/Meta/validation_report_formatters_v";

  // Parse a version string like "0.5.13" or "0.5.12.9003" into a numeric array.
